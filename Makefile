...
#	$(STRIP_x86) --strip-unneeded compiled/$(BOFNAME).x86.o
	...
	$(CC_x64)    source/load_ssp.c -o compiled/load_ssp.x64.exe     $(OPTIONS) -DEXE
	$(STRIP_x64) --strip-all compiled/load_ssp.x64.exe

	$(CC_x86)    source/load_ssp.c -o compiled/load_ssp.x86.exe     $(OPTIONS) -DEXE
	$(STRIP_x86) --strip-all compiled/load_ssp.x86.exe

	$(CC_x64) -c source/delete_file.c -o compiled/delete_file.x64.o $(OPTIONS) -DBOF
	$(STRIP_x64) --strip-unneeded compiled/delete_file.x64.o

	$(CC_x86) -c source/delete_file.c -o compiled/delete_file.x86.o $(OPTIONS) -DBOF
	$(STRIP_x86) --strip-unneeded compiled/delete_file.x86.o
...
#	$(CC_x86) -c source/entry.c -o compiled/$(BOFNAME).x86.o        $(OPTIONS) -DNANO -DBOF -DDEBUG
	...
	$(CC_x64)    source/load_ssp.c -o compiled/load_ssp.x64.exe     $(OPTIONS) -DEXE -DDEBUG

	$(CC_x86)    source/load_ssp.c -o compiled/load_ssp.x86.exe     $(OPTIONS) -DEXE -DDEBUG
